...
import org.kollavarsham.MalayalamCalendar;

public class CalendarTest {

	private MalayalamCalendar kvcal;
	private Celestial celestial;
	private Calendar gregcal, nextcal;
	...
	private Boolean cmpDates(Calendar one, Calendar two) {
		return one.getTime().toString().equals(two.getTime().toString());
	}
	...
	public void testFindSamkranti() {
		...
		// assertTrue(mymath.floatingPointEqual(kvcal.findSamkranti(1868266.0,
		// 1868267.0), 1868266.00000001));
		// assertTrue(mymath.floatingPointEqual(kvcal.findSamkranti(1721431.0,
		// 1721432.0), 1721431.9425787));
		// assertTrue(mymath.floatingPointEqual(kvcal.findSamkranti(2299153.0,
		// 2299154.0), 2299153.23922039));
